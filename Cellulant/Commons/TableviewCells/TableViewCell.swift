...
class TableViewCell: UITableViewCell {
    ...
    lazy var containerView: ViewX = {
        let view = ViewX()
        view.backgroundColor = .clear
        view.cornerRadius = Config.BaseDimensions.cornerRadius
        self.addSubview(view)
//        view.snp.makeConstraints({ (make) in
//            make.edges.equalToSuperview().inset(UIEdgeInsets(horizontal: self.10.0*2, vertical: self.10.0))
//        })
        return view
    }()
